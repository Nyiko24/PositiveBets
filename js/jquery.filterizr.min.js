!function(t) {
    ...
    : function(t) {
      ...
      , s = function t(e, r) {
        var n = o(r);
        for (var s in e)
            s in n ? "object" !== i(n[s]) || "object" !== i(e[s]) || Array.isArray(e[s]) || (n[s] = t("object" === i(n[s]) ? n[s] : {}, e[s])) : n[s] = e[s];
        return n
    }
      , a = function(t, e) {
      ...
      , c = function(t, e) {
        if (t.length !== e.length)
            return !1;
        for (var r = 0; r < t.length; r++)
            if (t[r].props.index !== e[r].props.index)
                return !1;
        return !0
    }
      , f = function(t, e) {
      ...
      , p = function(t, e, r, n, o) {
        if (void 0 !== e) {
            var s = new Error('Filterizr: expected type of option "' + t + '" to be "' + r + '", but its type is: "' + (void 0 === e ? "undefined" : i(e)) + '"')
              ...
              , l = !1
              , u = r.includes("array");
            if ((void 0 === e ? "undefined" : i(e)).match(r) ? a = !0 : !a && u && (l = Array.isArray(e)),
            !a && !u)
                throw s;
            if (!a && u && !l)
                throw s;
            ...
            if (Array.isArray(n)) {
                ...
                !f)
                    throw new Error('Filterizr: allowed values for option "' + t + '" are: ' + n.map(function(t) {
                        return '"' + t + '"'
                    }).join(", ") + '. Value received: "' + e + '".' + c(o))
            } else if (n instanceof RegExp) {
                var p = e.match(n);
                if (!p)
                    throw new Error('Filterizr: invalid value "' + e + '" for option "' + t + '" received.' + c(o))
            }
        }
    }
    ...
    var n = r(0)
      ...
      , s = function() {
        ...
        return o(t, [{
            ...
            value: function(t, e) {
                var r = 0;
                return "progressive" === e ? r = t * this.props.index : this.props.index % 2 == 0 && (r = t),
                r
            }
        }, {
    ...
    function(t) {
        ...
        t.fn.filterizr = function() {
            ...
            if (!this._fltr && 0 === r.length || 1 === r.length && "object" === u(r[0])) {
                ...
                switch (s) {
                case "filter":
                    return c.filter.apply(c, i(l)),
                    this;
                case "insertItem":
                    return c.insertItem.apply(c, i(l)),
                    this;
                case "toggleFilter":
                    return c.toggleFilter.apply(c, i(l)),
                    this;
                case "sort":
                    return c.sort.apply(c, i(l)),
                    this;
                case "shuffle":
                    return c.shuffle.apply(c, i(l)),
                    this;
                case "search":
                    return c.search.apply(c, i(l)),
                    this;
                case "setOptions":
                    return c.setOptions.apply(c, i(l)),
                    this;
                case "destroy":
                    return c.destroy.apply(c, i(l)),
                    delete this._fltr,
                    this;
                default:
      ...
      , f = function() {
        function t() {
            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : ".filtr-container"
              , r = arguments[1];
            i(this, t),
            this.options = Object(l.i)(a.a, r);
            var s = new o.a(e,this.options);
            if (!s.$node.length)
                throw new Error("Filterizr: could not find a container with the selector " + e + ", to initialize Filterizr.");
        ...
        return u(t, [{
            ...
            value: function(t) {
                ...
                Object(l.c)("easing", t.easing, "string", l.d, "https://www.w3schools.com/cssref/css3_pr_transition-timing-function.asp"),
                ...
                Object(l.c)("layout", t.layout, "string", ["sameSize", "vertical", "horizontal", "sameHeight", "sameWidth", "packed"]),
                Object(l.c)("multifilterLogicalOperator", t.multifilterLogicalOperator, "string", ["and", "or"]),
                Object(l.c)("setupControls", t.setupControls, "boolean"),
                this.options = Object(l.i)(this.options, t),
                (t.animationDuration || t.delay || t.delayMode || t.easing) && this.props.FilterContainer.updateFilterItemsTransitionStyle(t.animationDuration, t.easing, t.delay, t.delayMode),
            ...
            value: function(t) {
                ...
                1 === e.length && (e = e[0])) : e.push(t) : e = e === t ? "all" : [e, t],
            ...
            value: function() {
                ...
                c(window).on("resize.Filterizr", Object(l.e)(function() {
                    e.updateWidth(),
...
, function(t, e, r) {
    ...
    var i = function(t) {
        ...
        return r.updateHeight((s + 1) * i[0].props.h),
        l
    };
    e.a = i
}
, function(t, e, r) {
    ...
    var n = function(t) {
        ...
        return r.updateHeight(Math.max.apply(Math, i(l))),
        u
    }
      , o = function(t, e, r) {
        if (e <= 0)
...
, function(t, e, r) {
    ...
    var i = function(t) {
        ...
        return r.updateHeight(o.root.h),
        a
    }
      , n = function(t) {
        this.init(t)
    ...
    n.prototype = {
        ...
        fit: function(t) {
            ...
            e = 0; e < n; e++)
                i = t[e],
                (r = this.findNode(this.root, i.w, i.h)) ? i.fit = this.splitNode(r, i.w, i.h) : i.fit = this.growDown(i.w, i.h)
        },
